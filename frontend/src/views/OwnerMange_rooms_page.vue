...
class="px-4 py-2 bg-gray-800 rounded hover:bg-gray-900"
>
Clear
</button>
...
<div
@click="openEdit(room)"
class="flex items-center justify-center w-20 h-20 overflow-hidden text-xl transition-all rounded-xl"
:class="[
...
<button
@click="saveEdit"
class="px-5 py-2 text-white bg-blue-600 rounded-lg"
>
Save Changes
</button>
...
const toggleSelect = (id:number)=>{
  ...
  if(selectedRooms.value.includes(id)){
    ...
    selectedRooms.value =
      selectedRooms.value.filter(r=>r!==id)
